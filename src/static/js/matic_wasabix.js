...
const WASABIX_POOL_ABI = [
  {
    inputs: [
      ...
      {internalType: 'address', name: '_withdrawFeeCollector', type: 'address'},
    ],
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'contract IRewardVesting', name: 'rewardVesting', type: 'address'}],
    name: 'RewardVestingUpdated',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'address', name: 'sentinel', type: 'address'}],
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'address', name: 'withdrawFeeCollector', type: 'address'}],
    name: 'WithdrawFeeCollectorUpdated',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: true, internalType: 'uint256', name: 'pid', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'newWorkingAmount', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'newWorkingSupply', type: 'uint256'},
    ],
    name: 'WorkingAmountUpdate',
    type: 'event',
  },
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint256', name: '_earlyWithdrawFee', type: 'uint256'},
      {internalType: 'uint256', name: '_withdrawLock', type: 'uint256'},
      {internalType: 'bool', name: '_veBoostEnabled', type: 'bool'},
  ...
  },
  {
    inputs: [
      {internalType: 'uint256', name: '_poolId', type: 'uint256'},
      {internalType: 'uint256', name: '_userIndex', type: 'uint256'},
    ],
    name: 'getPoolUser',
  ...
  {
    inputs: [
      {internalType: 'contract IMintableERC20', name: '_rewardToken', type: 'address'},
      {internalType: 'contract IVotingEscrow', name: '_veWasabi', type: 'address'},
      {internalType: 'contract IRewardVesting', name: '_rewardVesting', type: 'address'},
      {internalType: 'bool', name: '_mintWasabi', type: 'bool'},
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'workingSupply', type: 'uint256'},
      {internalType: 'uint256', name: 'totalDeposited', type: 'uint256'},
      {internalType: 'bool', name: 'needVesting', type: 'bool'},
      {internalType: 'uint256', name: 'earlyWithdrawFee', type: 'uint256'},
      {internalType: 'uint256', name: 'withdrawLock', type: 'uint256'},
      {internalType: 'bool', name: 'veBoostEnabled', type: 'bool'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [],
    name: 'rewardVesting',
    outputs: [{internalType: 'contract IRewardVesting', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256[]', name: '_discountTable', type: 'uint256[]'}],
    name: 'setDiscountTable',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{internalType: 'uint256[]', name: '_feeLevel', type: 'uint256[]'}],
    name: 'setFeeLevel',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'contract IRewardVesting', name: '_rewardVesting', type: 'address'}],
  ...
  {
    inputs: [{internalType: 'address', name: '_newWithdrawFeeCollector', type: 'address'}],
    name: 'setWithdrawFeeCollector',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
function printBoostedAPR(
  ...
  _print(
    `After considering veWASABI boosting (Boost factor ${
      isNaN(parseFloat(userWorkingAmount / userStaked / 0.4).toFixed(2))
        ? '-'
        : parseFloat(userWorkingAmount / userStaked / 0.4).toFixed(2)
    }x), you own ${userStakedPct.toFixed(2)}% of the pool.`
  )
...
function printWasabixPool(
  ...
  const apr = printBoostedAPR(
    ...
    poolInfo.userStaked,
    poolInfo.totalWorkingSupply,
    poolInfo.userWorkingAmount,
    poolPrices.price,
    2
  )
...
async function loadWasabixStakingPoolsContract(
  App,
  tokens,
  prices,
  stakingPoolAddress,
